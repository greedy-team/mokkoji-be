...
public class EmailNotificationTest {
    @InjectMocks
    private RecruitmentNotificationEmailChannel recruitmentNotificationChannel;
    ...
    void setUp() {
        // TODO:: 다른 방법 생각해보기
        ReflectionTestUtils.setField(recruitmentNotificationChannel, "senderMail", "test@mokkoji.com");
    }
    ...
    void sendNotificationTest() {
        ...
        // when
        recruitmentNotificationChannel.sendNotification(receiverMails, clubId, clubName, recruitStart, recruitEnd);
